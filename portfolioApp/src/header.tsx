        ...
        <nav className={" flex flex-row items-center md:justify-around justify-evenly md: p-2 w-full"}>
          <a href="/"><h2 className='text-2xl text-indigo-600 font-bold font-[arial]'>LP</h2></a>
            ...
            <ul className='flex flex-row md:text-xl text-md sm:gap-6 gap-2 items-center md:w'>
              <div className="flex flex-row  gap-1 w-fit hover:underline-offset-3 hover:underline hover:text-indigo-600 font-[arial] ">
                <div className="" >
              ...
              <div className="flex flex-row hover:underline-offset-3 hover:underline hover:text-indigo-600 gap-1 w-fit font-[arial]">
                <div>
